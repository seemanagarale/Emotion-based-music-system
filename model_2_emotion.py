...
#print(df.info())
# this will give us no of columns,rows,datatypes

#print(df.columns.tolist())
# this will give you the column names
...
for index, row in df.iterrows():
    ...
    try:
        ...
        print(f"error occored at index {index} and row {row}")
...
#saving model
fer_json_new_4= model.to_json()
with open("fer.json_new_4","w") as json_file:
    json_file.write(fer_json_new_4)

model.save_weights("fer_new_4.h5")
